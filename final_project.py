...
from final_project_operators.final_project_sql_statements import SqlQueries
...
def final_project():
    ...
    stage_events_to_redshift = StageToRedshiftOperator(
        ...
        s3_bucket="awss3-sparkify-pipeline",
        s3_key="log-data",
        json_path="s3://awss3-sparkify-pipeline/log_json_path.json"
    )
    ...
    # STEP 3: SET UP THE DEPENDENCIES
